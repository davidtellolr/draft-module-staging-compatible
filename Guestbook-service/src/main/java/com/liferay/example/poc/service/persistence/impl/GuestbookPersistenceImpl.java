...
package com.liferay.example.poc.service.persistence.impl;

import com.liferay.example.poc.exception.NoSuchGuestbookException;
import com.liferay.example.poc.model.Guestbook;
import com.liferay.example.poc.model.impl.GuestbookImpl;
import com.liferay.example.poc.model.impl.GuestbookModelImpl;
import com.liferay.example.poc.service.persistence.GuestbookPersistence;
import com.liferay.example.poc.service.persistence.impl.constants.GuestbookPersistenceConstants;
...
public class GuestbookPersistenceImpl
	...
	@Override
	@Reference(
		target = GuestbookPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = GuestbookPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
